...
SAVE_DIR = "/storage/scratch2/dl-abdominal-mri-gan/chunk_epoch_training/noperce"
...
def generator_loss(disc_generated_output, gen_output, target):
    ...
    # SSIM LOSS
    # ---------------------------
    gen_output_01 = (gen_output + 1.0) * 0.5
...
def train_step(input_image, target, epoch):
    with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
        ...
        gen_total_loss, gen_gan_loss, gen_l1_loss, ssim_loss = generator_loss(
            disc_generated_output,
            gen_output,
            target
        )
    ...
    return gen_total_loss, gen_gan_loss, gen_l1_loss, ssim_loss, disc_loss
...
def fit(train_ds, test_ds, epochs):
    ...
    for epoch in range(initial_epoch, epochs):
        ...
        gen_total_loss, gen_gan_loss, gen_l1_loss, ssim_loss, disc_loss = train_losses
        gen_total_loss_val, gen_gan_loss_val, gen_l1_loss_val, ssim_loss_val, disc_loss_val = val_losses
        ...
        history["ssim_loss"].append(ssim_loss)
        ...
        history["ssim_loss_val"].append(ssim_loss_val)
